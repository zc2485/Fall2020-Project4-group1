...
| Low-Dim Running Time        | 13.03 sec| 20.40 sec| 21.01 sec|
| Low-Dim ATE Mean            |  2.67    | 1.97     | 2.56     | 
| Low-Dim ATE Standard Error  | 0.39     | 0.038    | 0.0013   |
| High-Dim Running Time       | 1.76 min | 4.29 min | 4.45 min |
...
To summarize our findings, Propensity Score Matching is unstable and sensitive to threshold choosing, which in turn determine the total number of matching pairs. Also, it has the highest complexity cost.
