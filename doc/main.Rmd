...
We are going to calculate ATE using three main methods, that is Propensity Matching, Inverse Propensity Weighting and Doubly Robust Estimation.
...
### 6.3 ATE Hist Plot for High-Dim
